...
_COMMIT=795f9a77a1c5c2cb847a89de403cd9dbfab85bd9
TERMUX_PKG_VERSION="0.0.1-r108.${_COMMIT:0:7}"
TERMUX_PKG_SRCURL=git+https://github.com/xMeM/vulkan-wsi-layer
TERMUX_PKG_SHA256="f16fdcdf4f77127e32ebb1f772ca45d2d1de8a7cc2df15f59d1d525d935192d8"
